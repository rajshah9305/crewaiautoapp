            ...
            <div className="mt-8">
                ...
                <div className="relative mt-2 group">
                    <textarea
                        ...
                        className="w-full bg-surface border-2 border-border rounded-xl p-4 pr-16 resize-none focus:outline-none focus:ring-2 focus:ring-primary/50 placeholder-text-secondary/80 text-base transition-all duration-200 shadow-md"
                        rows={3}
