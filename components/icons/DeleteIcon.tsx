...
const DeleteIcon: React.FC<{ className?: string, style?: React.CSSProperties }> = ({ className, style }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className} style={style}>
        <rect width="12" height="12" x="4" y="6" rx="2" opacity="0.2" />
        <path d="M10 9a1 1 0 100-2 1 1 0 000 2zm-2 1a1 1 0 112 0 1 1 0 01-2 0zm4 0a1 1 0 112 0 1 1 0 01-2 0zm-2 1a1 1 0 100 2 1 1 0 000-2z" />
