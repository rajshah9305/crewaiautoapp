...
const CopyIcon: React.FC<{ className?: string, style?: React.CSSProperties }> = ({ className, style }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className} style={style}>
      <path d="M7 3.5A1.5 1.5 0 018.5 2h5.25a.75.75 0 010 1.5H8.5A1.5 1.5 0 017 2V1.5z" opacity="0.3"/>
      <path d="M6.5 3.5v11a.5.5 0 00.5.5h7a.5.5 0 00.5-.5v-11a.5.5 0 00-.5-.5h-7a.5.5 0 00-.5.5z" opacity="0.3"/>
